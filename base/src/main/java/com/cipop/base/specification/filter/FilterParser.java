package com.cipop.base.specification.filter;

import com.cipop.base.specification.exception.SpecificationException;
import com.cipop.base.utils.CommonUtils;
...
public class FilterParser {
    ...
    private static ComparisonFilter getComparisonFilter(String field, StringTokenizer tokenizer, String... values){
        ...
        boolean notExistValue = CommonUtils.isEmpty(values) || (values.length == 1 && "".equals(values[0]));
